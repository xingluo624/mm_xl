...
if __name__ == "__main__":
    qwen_model_path = "/gemini-2/space/zjk/csq/507_2_1m_2taskallidx"
    lora_path = None
    ...
    for i in range(random_count):
        ...
        text = 'The scene consists of a white basket, a bottle of drink, and a dark-colored table. Use the right gripper to clamp the plastic water bottle, lift it up, move it above the basket, gently place the bottle into the basket, and then return to the starting position.'
        ...
        generated_ids = model.generate(**inputs, max_new_tokens=512,temperature=0.6,do_sample=True)
        ...
        print(f"提取的motion ids: {predmotion_ids}")
